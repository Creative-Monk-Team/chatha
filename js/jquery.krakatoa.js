...
;(function ($, window, document, undefined) {
	...
	Krakatoa.prototype = {
		init: function() {
			...
			slider.html( 
				'<div class="krakatoa-container">' + slider.html() + '</div>' + '<div class="krakatoa-control"></div>');
			...
			if (settings.items < length) {
				...
				if (settings.arrows) {
					slider.find('.krakatoa-control').append('<div class="arrows">' +
						'<a class="arrow arrow-left" data-direction="-1" href="#"><img src="images/left-arrow-white.png"></a>' +
						'<a class="arrow arrow-right" data-direction="1" href="#"><img src="images/right-arrow-white.png"></a>' +
						'</div>');
